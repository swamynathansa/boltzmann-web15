...
<div id="wrap">
  ...
  <?php 
    ...
    $slide4_head = check_plain(theme_get_setting('slide4_head','venture_theme'));   $slide4_desc = check_plain(theme_get_setting('slide4_desc','venture_theme')); $slide4_url = check_plain(theme_get_setting('slide4_url','venture_theme'));
    $slide5_head = check_plain(theme_get_setting('slide5_head','venture_theme'));   $slide5_desc = check_plain(theme_get_setting('slide5_desc','venture_theme')); $slide5_url = check_plain(theme_get_setting('slide5_url','venture_theme'));
  ?>
        ...
        <li class="homepage-slider-slide">
          <a href="<?php print url($slide4_url); ?>">
            <div class="homepage-slide-inner container">
              ...
              <div class="homepage-slide-content">
                <div class="homepage-slide-title"><?php print $slide4_head; ?></div>
                <div class="clr"></div>
                <div class="homepage-slide-caption"><?php print $slide4_desc; ?></div>
              </div>
              <?php endif; ?>
            </div>
            <img src="<?php print base_path() . drupal_get_path('theme', 'venture_theme') . '/images/slide-image-4.jpg'; ?>">
          </a>
        </li>
        <li class="homepage-slider-slide">
          <a href="<?php print url($slide5_url); ?>">
            <div class="homepage-slide-inner container">
              <?php if($slide5_head || $slide5_desc) : ?>
              <div class="homepage-slide-content">
                <div class="homepage-slide-title"><?php print $slide5_head; ?></div>
                <div class="clr"></div>
                <div class="homepage-slide-caption"><?php print $slide5_desc; ?></div>
              </div>
              <?php endif; ?>
            </div>
            <img src="<?php print base_path() . drupal_get_path('theme', 'venture_theme') . '/images/slide-image-5.jpg'; ?>">
          </a>
        </li>
      </ul>
    </div>
